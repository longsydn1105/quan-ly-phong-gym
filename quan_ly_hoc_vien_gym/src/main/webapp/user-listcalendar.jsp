...
<body>
            ...
            <div class="activity">
                ...
                <div class="classes">
                	<%
                		...
                		ArrayList<Classes> listClass = classDAO.getUpcomingClassesByUser(userID);
                		if(listClass != null){
                	%>
                	<%
                	...
                	%>
                    <div class="class-card" onclick="confirmDeleteRegistration('<%=objClass.getClassId() %>')">
    ...
    <script>
    function confirmDeleteRegistration(classId) {
    	console.log("Class ID:", classId); // Kiểm tra giá trị classId
        const userConfirmed = confirm("Bạn có muốn xoá đăng ký lớp này không?");
        if (userConfirmed) {
            // Chuyển hướng tới trang xác nhận đăng ky
            window.location.href = './xoa-dang-ky?classId=' + classId;
        }
    }
	</script>
